...
const OG_IMAGE = `${BASE_URL}/og-image?title=${encodeURIComponent("Inglés viviendo la vida real")}&subtitle=${encodeURIComponent("Salidas por Tehuacán y viajes a Puebla")}`;
