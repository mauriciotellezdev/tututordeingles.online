...
export async function bookIntroCallAction(payload: {
  ...
  try {
    ...
    const icsContent = [
      ...
      "DESCRIPTION:Tu llamada introductoria de 30 minutos con Mauricio. Enlace de Google Meet: https://meet.google.com/hfs-xjqt-wkq",
